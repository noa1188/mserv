...
# 9. 输出信息和二维码
VLESS_LINK="vless://${UUID}@${SERVER_IP}:${REALITY_PORT}?security=reality&encryption=none&pbk=${PUBLIC_KEY}&headerType=none&fp=chrome&type=tcp&sni=${SNI}&sid=${SHORT_ID}&flow=xtls-rprx-vision#SingBox-Reality"
HY2_LINK="hy2://${HY2_PASSWORD}@${SERVER_IP}:${HY2_PORT}/?insecure=1&sni=bing.com#SingBox-Hysteria2"
